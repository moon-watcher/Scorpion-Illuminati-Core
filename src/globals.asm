...
greennote_start_position_x:  equ 0x00D0
rednote_start_position_x:  equ 0x00F8
yellownote_start_position_x:  equ 0x0120
bluenote_start_position_x:  equ 0x0148
orangenote_start_position_x:  equ 0x0170

; note boundry locations
note_plane_border_offset:  equ 0x014A
note_plane_safearea_offset:  equ 0x010A
